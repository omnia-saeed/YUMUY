...
function displayCategories() {
  ...
  for (var i = 0; i < arr.length; i++)
    e += `
    <div class="col-md-6 col-lg-3 my-3 omnia shadow">
...
function displayMeal(meal) {
  ...
  let str = `
    <div class="col-md-4 omnia text-white">
					<img class="w-100" src="${meal.strMealThumb}" alt=""
						srcset=""><br>
					<h1>${meal.strMeal}</h1>
				</div>
      
				<div class="col-md-8 omnia text-white text-left">
...
$(".nav-item a").click(async (e) => {
  ...
  if ( listEV == "contact") {
    row.innerHTML = `
        <section id="contact" class="container omnia w-75 mx-auto mb-5 ">
		<div class="p-2">
